...
public class Spawner : MonoBehaviour {
	...
	public void Start () {
		...
		while (spawned < getAmount) {
			...
			//Renoves the spawned object from the sdpawner object
	...
	void Update (){
		...
		if (delaySpawn < timer) {
			//And we haven't reached the sapwn amount
	...
	{
		//Fraw the wireframe mexh of what we intentd to spawn in our editor
